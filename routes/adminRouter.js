...
router.get('/admin/chefs', access.isAuthenticated, access.isAdmin, admin.getChefsPage);
...
router.post('/admin/chef', upload.single('chefimage'), access.isAuthenticated, access.isAdmin, admin.postChef);
...
router.post('/admin/chef/delete/:id', access.isAuthenticated, access.isAdmin, admin.deleteChef);
