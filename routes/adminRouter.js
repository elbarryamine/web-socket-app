...
router.get('/admin/info', access.isAuthenticated, access.isAdmin, admin.getInfoPage);
...
router.post('/admin/info', upload.none(), access.isAuthenticated, access.isAdmin, admin.postInfo);
